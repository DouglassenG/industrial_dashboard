...
export default function MachineStateCard({ state }: Props) {
  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-xl p-4 sm:p-5 sm:pl-10 shadow-sm hover:shadow-md border border-gray-300 dark:border-gray-700 flex flex-col gap-3 overflow-hidden transition-all duration-300">
