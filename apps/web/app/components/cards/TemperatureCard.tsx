...
export default function TemperatureCard({ temperature, max, trend }: Props) {
  return (
    <div
      className={`rounded-xl p-5 shadow-sm border transition-all duration-300 hover:-translate-y-1 hover:shadow-md animate-fade-in ${
        temperature >= max
          ? "bg-red-50 dark:bg-red-900/20 border-red-400 dark:border-red-600"
          : "bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-800/60"
      }`}
    >
