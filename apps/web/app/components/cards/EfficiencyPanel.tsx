...
export default function EfficiencyPanel({ oee }: Props) {
  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-xl p-5 pl-10 shadow-sm hover:shadow-md border border-gray-300 dark:border-gray-700 sm:flex-1 sm:min-h-0 flex flex-col gap-4 transition-all duration-300">
